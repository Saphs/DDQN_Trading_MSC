...
from dqn_legacy_code.PatternDetectionInCandleStick.LabelPatterns import label_candles
...
class YahooFinanceDataLoader:
    ...
    def load_data(self) -> (pd.DataFrame, typing.List[str]):
        """
        This function is used to read and clean data from .csv file.
        @return:
        """
        data: pd.DataFrame = pd.read_csv(f'{self.DATA_PATH}{self.DATA_FILE}')
